...
# Database: phpcms
# Generation Time: 2018-05-31 02:12:47 +0000
# ************************************************************
...
INSERT INTO `v_admin` (`userid`, `username`, `password`, `roleid`, `encrypt`, `lastloginip`, `lastlogintime`, `email`, `realname`, `card`, `lang`)
VALUES
	(1,'admin','4151eb6593ce5a6302c1bcca75ba525e',1,'F4nqmy','',1527679506,'925759614@qq.com','','','');

/*!40000 ALTER TABLE `v_admin` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_admin_panel
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_admin_panel`;

CREATE TABLE `v_admin_panel` (
...
LOCK TABLES `v_admin_role` WRITE;
/*!40000 ALTER TABLE `v_admin_role` DISABLE KEYS */;

INSERT INTO `v_admin_role` (`roleid`, `rolename`, `description`, `listorder`, `disabled`)
VALUES
	(1,'超级管理员','超级管理员',0,0),
	(2,'站点管理员','站点管理员',0,0),
	(3,'运营总监','运营总监',1,0),
...
/*!40000 ALTER TABLE `v_admin_role` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_admin_role_priv
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_admin_role_priv`;

CREATE TABLE `v_admin_role_priv` (
...
# Dump of table v_announce
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_announce`;

CREATE TABLE `v_announce` (
...
# Dump of table v_attachment_index
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_attachment_index`;

CREATE TABLE `v_attachment_index` (
...
# Dump of table v_badword
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_badword`;

CREATE TABLE `v_badword` (
...
# Dump of table v_block
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_block`;

CREATE TABLE `v_block` (
...
# Dump of table v_block_history
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_block_history`;

CREATE TABLE `v_block_history` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
# Dump of table v_block_priv
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_block_priv`;

CREATE TABLE `v_block_priv` (
...
# Dump of table v_cache
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_cache`;

CREATE TABLE `v_cache` (
  `filename` char(50) NOT NULL,
...
LOCK TABLES `v_cache` WRITE;
/*!40000 ALTER TABLE `v_cache` DISABLE KEYS */;

INSERT INTO `v_cache` (`filename`, `path`, `data`)
VALUES
...
/*!40000 ALTER TABLE `v_cache` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_category
# ------------------------------------------------------------
...
INSERT INTO `v_category` (`catid`, `siteid`, `module`, `type`, `modelid`, `parentid`, `arrparentid`, `child`, `arrchildid`, `catname`, `style`, `image`, `description`, `parentdir`, `catdir`, `url`, `items`, `hits`, `setting`, `listorder`, `ismenu`, `sethtml`, `letter`, `usable_type`)
VALUES
...
# Dump of table v_category_priv
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_category_priv`;

CREATE TABLE `v_category_priv` (
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
# Dump of table v_collection_content
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_collection_content`;

CREATE TABLE `v_collection_content` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table v_collection_history
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_collection_history`;

CREATE TABLE `v_collection_history` (
...
# Dump of table v_collection_node
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_collection_node`;

CREATE TABLE `v_collection_node` (
...
# Dump of table v_collection_program
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_collection_program`;

CREATE TABLE `v_collection_program` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `nodeid` int(10) unsigned NOT NULL DEFAULT '0',
...
# Dump of table v_comment_check
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_comment_check`;

CREATE TABLE `v_comment_check` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
# Dump of table v_comment_data_1
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_comment_data_1`;

CREATE TABLE `v_comment_data_1` (
...
# Dump of table v_comment_setting
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_comment_setting`;

CREATE TABLE `v_comment_setting` (
  `siteid` smallint(5) NOT NULL DEFAULT '0' COMMENT '站点ID',
...
LOCK TABLES `v_comment_setting` WRITE;
/*!40000 ALTER TABLE `v_comment_setting` DISABLE KEYS */;

INSERT INTO `v_comment_setting` (`siteid`, `guest`, `check`, `code`, `add_point`, `del_point`)
VALUES
	(1,0,0,0,0,0);

/*!40000 ALTER TABLE `v_comment_setting` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_comment_table
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_comment_table`;

CREATE TABLE `v_comment_table` (
...
LOCK TABLES `v_comment_table` WRITE;
/*!40000 ALTER TABLE `v_comment_table` DISABLE KEYS */;

INSERT INTO `v_comment_table` (`tableid`, `total`, `creat_at`)
VALUES
	(1,0,0);

/*!40000 ALTER TABLE `v_comment_table` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_content_check
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_content_check`;

CREATE TABLE `v_content_check` (
...
# Dump of table v_copyfrom
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_copyfrom`;

CREATE TABLE `v_copyfrom` (
...
# Dump of table v_datacall
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_datacall`;

CREATE TABLE `v_datacall` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
# Dump of table v_dbsource
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_dbsource`;

CREATE TABLE `v_dbsource` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
# Dump of table v_download_data
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_download_data`;

CREATE TABLE `v_download_data` (
...
# Dump of table v_downservers
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_downservers`;

CREATE TABLE `v_downservers` (
...
# Dump of table v_extend_setting
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_extend_setting`;

CREATE TABLE `v_extend_setting` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table v_hits
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_hits`;
...
# Dump of table v_ipbanned
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_ipbanned`;

CREATE TABLE `v_ipbanned` (
...
# Dump of table v_keylink
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_keylink`;

CREATE TABLE `v_keylink` (
...
# Dump of table v_keyword_data
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_keyword_data`;

CREATE TABLE `v_keyword_data` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `v_link` WRITE;
/*!40000 ALTER TABLE `v_link` DISABLE KEYS */;

INSERT INTO `v_link` (`linkid`, `siteid`, `typeid`, `linktype`, `name`, `url`, `logo`, `introduce`, `username`, `listorder`, `elite`, `passed`, `addtime`)
VALUES
	(1,1,0,1,'PHPCMS','http://www.phpcms.cn','http://www.phpcms.cn/images/logo_88_31.gif','','',0,0,1,1527602165),
	(2,1,0,1,'盛大在线','http://www.sdo.com','http://www.snda.com/cn/logo/comp_logo_sdo.gif','','',0,0,1,1527602165);

/*!40000 ALTER TABLE `v_link` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_linkage
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_linkage`;

CREATE TABLE `v_linkage` (
...
LOCK TABLES `v_linkage` WRITE;
/*!40000 ALTER TABLE `v_linkage` DISABLE KEYS */;

INSERT INTO `v_linkage` (`linkageid`, `name`, `style`, `parentid`, `child`, `arrchildid`, `keyid`, `listorder`, `description`, `setting`, `siteid`)
VALUES
...
/*!40000 ALTER TABLE `v_linkage` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `v_log` WRITE;
/*!40000 ALTER TABLE `v_log` DISABLE KEYS */;

INSERT INTO `v_log` (`logid`, `field`, `value`, `module`, `file`, `action`, `querystring`, `data`, `userid`, `username`, `ip`, `time`)
VALUES
	(1,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 21:56:09'),
	(2,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 21:56:09'),
	(3,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 21:56:15'),
	(4,'',0,'template','','style','?m=template&c=style&a=import','',1,'admin','','2018-05-29 21:58:36'),
	(5,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 22:06:17'),
	(6,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 22:07:10'),
	(7,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 22:07:11'),
	(8,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 22:07:14'),
	(9,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 22:07:15'),
	(10,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 22:11:51'),
	(11,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 22:16:17'),
	(12,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 22:16:26'),
	(13,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 22:16:27'),
	(14,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 22:17:00'),
	(15,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 22:17:39'),
	(16,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 22:17:45'),
	(17,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 22:17:46'),
	(18,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-29 22:17:53'),
	(19,'',0,'admin','','site','?m=admin&c=site&a=edit','',1,'admin','','2018-05-29 22:19:04'),
	(20,'',0,'admin','','site','?m=admin&c=site&a=edit','',1,'admin','','2018-05-29 22:19:35'),
	(21,'',0,'admin','','site','?m=admin&c=site&a=edit','',1,'admin','','2018-05-29 22:48:09'),
	(22,'',0,'admin','','release_point','?m=admin&c=release_point&a=add','',1,'admin','','2018-05-29 22:48:36'),
	(23,'',0,'admin','','index','?m=admin&c=index&a=login','',1,'admin','','2018-05-29 22:50:32'),
	(24,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-30 19:24:57'),
	(25,'',0,'admin','','index','?m=admin&c=index&a=login','',0,'','','2018-05-30 19:25:06');

/*!40000 ALTER TABLE `v_log` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_member
# ------------------------------------------------------------
...
# Dump of table v_member_detail
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_member_detail`;

CREATE TABLE `v_member_detail` (
  `userid` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
# Dump of table v_member_group
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_member_group`;

CREATE TABLE `v_member_group` (
...
LOCK TABLES `v_member_group` WRITE;
/*!40000 ALTER TABLE `v_member_group` DISABLE KEYS */;

INSERT INTO `v_member_group` (`groupid`, `name`, `issystem`, `starnum`, `point`, `allowmessage`, `allowvisit`, `allowpost`, `allowpostverify`, `allowsearch`, `allowupgrade`, `allowsendmessage`, `allowpostnum`, `allowattachment`, `price_y`, `price_m`, `price_d`, `icon`, `usernamecolor`, `description`, `sort`, `disabled`)
VALUES
...
/*!40000 ALTER TABLE `v_member_group` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_member_menu
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_member_menu`;

CREATE TABLE `v_member_menu` (
...
LOCK TABLES `v_member_menu` WRITE;
/*!40000 ALTER TABLE `v_member_menu` DISABLE KEYS */;

INSERT INTO `v_member_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `listorder`, `display`, `isurl`, `url`)
VALUES
...
/*!40000 ALTER TABLE `v_member_menu` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_member_verify
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_member_verify`;

CREATE TABLE `v_member_verify` (
  `userid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
  `username` char(20) NOT NULL,
...
# Dump of table v_member_vip
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_member_vip`;

CREATE TABLE `v_member_vip` (
  `userid` mediumint(8) unsigned NOT NULL DEFAULT '0',
  UNIQUE KEY `userid` (`userid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `v_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`)
VALUES
...
# Dump of table v_message_data
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_message_data`;

CREATE TABLE `v_message_data` (
...
# Dump of table v_message_group
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_message_group`;

CREATE TABLE `v_message_group` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `typeid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
LOCK TABLES `v_model` WRITE;
/*!40000 ALTER TABLE `v_model` DISABLE KEYS */;

INSERT INTO `v_model` (`modelid`, `siteid`, `name`, `description`, `tablename`, `setting`, `addtime`, `items`, `enablesearch`, `disabled`, `default_style`, `category_template`, `list_template`, `show_template`, `js_template`, `admin_list_template`, `member_add_template`, `member_list_template`, `sort`, `type`)
VALUES
...
/*!40000 ALTER TABLE `v_model` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_model_field
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_model_field`;

CREATE TABLE `v_model_field` (
...
LOCK TABLES `v_model_field` WRITE;
/*!40000 ALTER TABLE `v_model_field` DISABLE KEYS */;

INSERT INTO `v_model_field` (`fieldid`, `modelid`, `siteid`, `field`, `name`, `tips`, `css`, `minlength`, `maxlength`, `pattern`, `errortips`, `formtype`, `setting`, `formattribute`, `unsetgroupids`, `unsetroleids`, `iscore`, `issystem`, `isunique`, `isbase`, `issearch`, `isadd`, `isfulltext`, `isposition`, `listorder`, `disabled`, `isomnipotent`)
VALUES
...
/*!40000 ALTER TABLE `v_model_field` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_module
# ------------------------------------------------------------
...
LOCK TABLES `v_module` WRITE;
/*!40000 ALTER TABLE `v_module` DISABLE KEYS */;

INSERT INTO `v_module` (`module`, `name`, `url`, `iscore`, `version`, `description`, `setting`, `listorder`, `disabled`, `installdate`, `updatedate`)
VALUES
	...
	('announce','公告','announce/',0,'1.0','公告','',0,0,'2018-05-29','2018-05-29'),
	('comment','评论','comment/',0,'1.0','评论','',0,0,'2018-05-29','2018-05-29'),
	('link','友情链接','',0,'1.0','','array (\n  1 => \n  array (\n    \'is_post\' => \'1\',\n    \'enablecheckcode\' => \'0\',\n  ),\n)',0,0,'2010-09-06','2010-09-06'),
	('vote','投票','',0,'1.0','','array (\r\n  1 => \r\n  array (\r\n    \'default_style\' => \'default\',\r\n    \'vote_tp_template\' => \'vote_tp\',\r\n    \'allowguest\' => \'1\',\r\n    \'enabled\' => \'1\',\r\n    \'interval\' => \'1\',\r\n    \'credit\' => \'1\',\r\n  ),\r\n)',0,0,'2010-09-06','2010-09-06'),
	('message','短消息','',0,'1.0','','',0,0,'2010-09-06','2010-09-06'),
	('mood','新闻心情','mood/',0,'1.0','新闻心情','',0,0,'2018-05-29','2018-05-29'),
	('poster','广告模块','poster/',0,'1.0','广告模块','',0,0,'2018-05-29','2018-05-29'),
	('formguide','表单向导','formguide/',0,'1.0','formguide','array (\n  \'allowmultisubmit\' => \'1\',\n  \'interval\' => \'30\',\n  \'allowunreg\' => \'0\',\n  \'mailmessage\' => \'用户向我们提交了表单数据，赶快去看看吧。\',\n)',0,0,'2010-10-20','2010-10-20'),
	('wap','手机门户','wap/',0,'1.0','手机门户','',0,0,'2018-05-29','2018-05-29'),
	('upgrade','在线升级','',0,'1.0','','',0,0,'2011-05-18','2011-05-18'),
	('tag','标签向导','tag/',0,'1.0','标签向导','',0,0,'2018-05-29','2018-05-29'),
	('sms','短信平台','sms/',0,'1.0','短信平台','',0,0,'2011-09-02','2011-09-02');

/*!40000 ALTER TABLE `v_module` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_mood
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_mood`;
...
# Dump of table v_news_data
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_news_data`;

CREATE TABLE `v_news_data` (
  `id` mediumint(8) unsigned DEFAULT '0',
...
# Dump of table v_pay_account
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_pay_account`;

CREATE TABLE `v_pay_account` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table v_pay_payment
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_pay_payment`;

CREATE TABLE `v_pay_payment` (
...
# Dump of table v_pay_spend
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_pay_spend`;

CREATE TABLE `v_pay_spend` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table v_picture_data
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_picture_data`;

CREATE TABLE `v_picture_data` (
  `id` mediumint(8) unsigned DEFAULT '0',
  `content` text NOT NULL,
  `readpoint` smallint(5) unsigned NOT NULL DEFAULT '0',
  `groupids_view` varchar(100) NOT NULL,
...
LOCK TABLES `v_position` WRITE;
/*!40000 ALTER TABLE `v_position` DISABLE KEYS */;

INSERT INTO `v_position` (`posid`, `modelid`, `catid`, `name`, `maxnum`, `extention`, `listorder`, `siteid`, `thumb`)
VALUES
...
/*!40000 ALTER TABLE `v_position` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_position_data
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_position_data`;

CREATE TABLE `v_position_data` (
...
# Dump of table v_poster
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_poster`;

CREATE TABLE `v_poster` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
LOCK TABLES `v_poster` WRITE;
/*!40000 ALTER TABLE `v_poster` DISABLE KEYS */;

INSERT INTO `v_poster` (`id`, `siteid`, `name`, `spaceid`, `type`, `setting`, `startdate`, `enddate`, `addtime`, `hits`, `clicks`, `listorder`, `disabled`)
VALUES
	(1,1,'banner',1,'images','array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://www.phpcms.com/uploadfile/poster/2.png\',\n    \'alt\' => \'\',\n  ),\n)',1285813808,1446249600,1285813833,0,1,0,0),
	(2,1,'phpcmsv9',2,'images','array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://www.phpcms.com/statics/images/v9/ad_login.jpg\',\n    \'alt\' => \'phpcms专业建站系统\',\n  ),\n)',1285816298,1446249600,1285816310,0,1,0,0),
	(3,1,'phpcms下载推荐',3,'images','array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://www.phpcms.com/uploadfile/poster/3.png\',\n    \'alt\' => \'phpcms官方\',\n  ),\n)',1286504815,1446249600,1286504865,0,1,0,0),
	(4,1,'phpcms广告',4,'images','array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://www.phpcms.com/uploadfile/poster/4.gif\',\n    \'alt\' => \'phpcms官方\',\n  ),\n)',1286505141,1446249600,1286505178,0,0,0,0),
	(5,1,'phpcms下载',5,'images','array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://www.phpcms.com/uploadfile/poster/5.gif\',\n    \'alt\' => \'官方\',\n  ),\n)',1286509363,1446249600,1286509401,0,0,0,0),
	...
	(8,1,'phpcms下载页',8,'images','array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://www.phpcms.com/uploadfile/poster/1.jpg\',\n    \'alt\' => \'官方站\',\n  ),\n)',1286522084,1446249600,1286522125,0,0,0,0),
	(9,1,'phpcms v9广告',9,'images','array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://www.phpcms.com/uploadfile/poster/4.gif\',\n    \'alt\' => \'\',\n  ),\n)',1287041759,1446249600,1287041804,0,0,0,0),
	(10,1,'phpcms',10,'images','array (\n  1 => \n  array (\n    \'linkurl\' => \'http://www.phpcms.cn\',\n    \'imageurl\' => \'http://www.phpcms.com/uploadfile/poster/6.jpg\',\n    \'alt\' => \'phpcms官方\',\n  ),\n)',1289270509,1446249600,1289270541,1,0,0,0);

/*!40000 ALTER TABLE `v_poster` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_poster_201805
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_poster_201805`;

CREATE TABLE `v_poster_201805` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table v_poster_space
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_poster_space`;

CREATE TABLE `v_poster_space` (
...
LOCK TABLES `v_poster_space` WRITE;
/*!40000 ALTER TABLE `v_poster_space` DISABLE KEYS */;

INSERT INTO `v_poster_space` (`spaceid`, `siteid`, `name`, `type`, `path`, `width`, `height`, `setting`, `description`, `items`, `disabled`)
VALUES
...
/*!40000 ALTER TABLE `v_poster_space` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_queue
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_queue`;

CREATE TABLE `v_queue` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
# Dump of table v_release_point
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_release_point`;

CREATE TABLE `v_release_point` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
# Dump of table v_search_keyword
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_search_keyword`;

CREATE TABLE `v_search_keyword` (
...
LOCK TABLES `v_session` WRITE;
/*!40000 ALTER TABLE `v_session` DISABLE KEYS */;

INSERT INTO `v_session` (`sessionid`, `userid`, `ip`, `lastvisit`, `roleid`, `groupid`, `m`, `c`, `a`, `data`)
VALUES
	('0fbfb75a9f40b8baffa4f10dbfa3aea2',1,'',1527680847,1,0,'admin','index','public_session_life','code|s:0:\"\";userid|s:1:\"1\";roleid|s:1:\"1\";pc_hash|s:6:\"WCwVdV\";lock_screen|i:0;');

/*!40000 ALTER TABLE `v_session` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_site
# ------------------------------------------------------------
...
LOCK TABLES `v_site` WRITE;
/*!40000 ALTER TABLE `v_site` DISABLE KEYS */;

INSERT INTO `v_site` (`siteid`, `name`, `dirname`, `domain`, `site_title`, `keywords`, `description`, `release_point`, `default_style`, `template`, `setting`, `uuid`)
VALUES
	(1,'默认站点','','http://www.phpcms.com/','PHPCMS演示站','PHPCMS演示站','PHPCMS演示站','','default','default','{\"upload_maxsize\":\"2048\",\"upload_allowext\":\"jpg|jpeg|gif|bmp|png|doc|docx|xls|xlsx|ppt|pptx|pdf|txt|rar|zip|swf\",\"watermark_enable\":\"0\",\"watermark_minwidth\":\"300\",\"watermark_minheight\":\"300\",\"watermark_img\":\"statics\\/images\\/water\\/\\/mark.png\",\"watermark_pct\":\"85\",\"watermark_quality\":\"80\",\"watermark_pos\":\"9\"}','0ee17bae-6348-11e8-80d5-56c8eb4287df');

/*!40000 ALTER TABLE `v_site` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_sms_report
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_sms_report`;

CREATE TABLE `v_sms_report` (
...
# Dump of table v_special
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_special`;

CREATE TABLE `v_special` (
  `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,
  `siteid` smallint(5) unsigned NOT NULL DEFAULT '0',
...
# Dump of table v_special_c_data
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_special_c_data`;

CREATE TABLE `v_special_c_data` (
  `id` mediumint(8) unsigned NOT NULL DEFAULT '0',
...
# Dump of table v_special_content
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_special_content`;

CREATE TABLE `v_special_content` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table v_sphinx_counter
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_sphinx_counter`;

CREATE TABLE `v_sphinx_counter` (
...
# Dump of table v_sso_admin
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_sso_admin`;

CREATE TABLE `v_sso_admin` (
...
LOCK TABLES `v_sso_admin` WRITE;
/*!40000 ALTER TABLE `v_sso_admin` DISABLE KEYS */;

INSERT INTO `v_sso_admin` (`id`, `username`, `password`, `encrypt`, `issuper`, `lastlogin`, `ip`)
VALUES
	(1,'admin','a355ca05c285a14807bee1dc50d8c28c','bncXyB',1,0,'');

/*!40000 ALTER TABLE `v_sso_admin` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_sso_applications
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_sso_applications`;

CREATE TABLE `v_sso_applications` (
...
LOCK TABLES `v_sso_applications` WRITE;
/*!40000 ALTER TABLE `v_sso_applications` DISABLE KEYS */;

INSERT INTO `v_sso_applications` (`appid`, `type`, `name`, `url`, `authkey`, `ip`, `apifilename`, `charset`, `synlogin`)
VALUES
	(1,'phpcms_v9','phpcms v9','http://www.phpcms.com/','SWBp8yGERAhlpa4NQaviz9MhcogQbEhN','','api.php?op=phpsso','utf-8',1);

/*!40000 ALTER TABLE `v_sso_applications` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_sso_members
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_sso_members`;

CREATE TABLE `v_sso_members` (
...
# Dump of table v_sso_messagequeue
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_sso_messagequeue`;

CREATE TABLE `v_sso_messagequeue` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
# Dump of table v_sso_session
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_sso_session`;

CREATE TABLE `v_sso_session` (
  `sessionid` char(32) NOT NULL,
  `userid` mediumint(8) unsigned NOT NULL DEFAULT '0',
  `ip` char(15) NOT NULL,
  `lastvisit` int(10) unsigned NOT NULL DEFAULT '0',
...
# Dump of table v_sso_settings
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_sso_settings`;

CREATE TABLE `v_sso_settings` (
  `name` varchar(32) NOT NULL DEFAULT '',
  `data` text NOT NULL,
  PRIMARY KEY (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

LOCK TABLES `v_sso_settings` WRITE;
/*!40000 ALTER TABLE `v_sso_settings` DISABLE KEYS */;

INSERT INTO `v_sso_settings` (`name`, `data`)
VALUES
	('denyemail',''),
	('denyusername',''),
	('creditrate',''),
...
/*!40000 ALTER TABLE `v_sso_settings` ENABLE KEYS */;
UNLOCK TABLES;
...
# Dump of table v_template_bak
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_template_bak`;

CREATE TABLE `v_template_bak` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `creat_at` int(10) unsigned DEFAULT '0',
...
# Dump of table v_times
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_times`;

CREATE TABLE `v_times` (
  `username` char(40) NOT NULL,
  `ip` char(15) NOT NULL,
...
INSERT INTO `v_type` (`typeid`, `siteid`, `module`, `modelid`, `name`, `parentid`, `typedir`, `url`, `template`, `listorder`, `description`)
VALUES
...
# Dump of table v_urlrule
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_urlrule`;

CREATE TABLE `v_urlrule` (
...
LOCK TABLES `v_urlrule` WRITE;
/*!40000 ALTER TABLE `v_urlrule` DISABLE KEYS */;

INSERT INTO `v_urlrule` (`urlruleid`, `module`, `file`, `ishtml`, `urlrule`, `example`)
VALUES
...
/*!40000 ALTER TABLE `v_urlrule` ENABLE KEYS */;
UNLOCK TABLES;
...
# Dump of table v_video_content
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_video_content`;

CREATE TABLE `v_video_content` (
...
# Dump of table v_video_store
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_video_store`;

CREATE TABLE `v_video_store` (
...
# Dump of table v_vote_data
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_vote_data`;

CREATE TABLE `v_vote_data` (
  `userid` mediumint(8) unsigned DEFAULT '0',
  `username` char(20) NOT NULL,
...
# Dump of table v_vote_option
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_vote_option`;

CREATE TABLE `v_vote_option` (
...
# Dump of table v_vote_subject
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_vote_subject`;

CREATE TABLE `v_vote_subject` (
...
LOCK TABLES `v_wap` WRITE;
/*!40000 ALTER TABLE `v_wap` DISABLE KEYS */;

INSERT INTO `v_wap` (`siteid`, `sitename`, `logo`, `domain`, `setting`, `status`)
VALUES
	(1,'PHPCMS手机门户','/statics/images/wap/wlogo.gif','','array (\n  \'listnum\' => \'10\',\n  \'thumb_w\' => \'220\',\n  \'thumb_h\' => \'0\',\n  \'c_num\' => \'1000\',\n  \'index_template\' => \'index\',\n  \'category_template\' => \'category\',\n  \'list_template\' => \'list\',\n  \'show_template\' => \'show\',\n)',0);

/*!40000 ALTER TABLE `v_wap` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table v_wap_type
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_wap_type`;

CREATE TABLE `v_wap_type` (
...
# Dump of table v_workflow
# ------------------------------------------------------------

DROP TABLE IF EXISTS `v_workflow`;

CREATE TABLE `v_workflow` (
...
LOCK TABLES `v_workflow` WRITE;
/*!40000 ALTER TABLE `v_workflow` DISABLE KEYS */;

INSERT INTO `v_workflow` (`workflowid`, `siteid`, `steps`, `workname`, `description`, `setting`, `flag`)
VALUES
	(1,1,1,'一级审核','审核一次','',0),
	(2,1,2,'二级审核','审核两次','',0),
	(3,1,3,'三级审核','审核三次','',0),
...
/*!40000 ALTER TABLE `v_workflow` ENABLE KEYS */;
UNLOCK TABLES;
